...
class ProductTest {
    ...
    void setUp() {
        ...
        try {
            milkId1=milk.addSupply(1, LocalDate.now(), 10, 10).getSupplyID();
            milkId2=milk.addSupply(2, LocalDate.now(), 10, 10).getSupplyID();

            iceId1=ice.addSupply(1, LocalDate.now(), 0, 10).getSupplyID();
            iceId2=ice.addSupply(2, LocalDate.now(), 10, 0).getSupplyID();

            waterId1=water.addSupply(1, LocalDate.now(), 5, 5).getSupplyID();
            waterId2=water.addSupply(2, LocalDate.now(), 5, 5).getSupplyID();
        }
    ...
    void calcMinQuantity() {
        ...
        assertEquals(32,milk.getMinQuantity());
        assertEquals(24,ice.getMinQuantity());
        assertEquals(8,water.getMinQuantity());
    ...
    void addSupply() {
        ...
        try {
            mid=milk.addSupply(1, LocalDate.now(), 10, 10).getSupplyID();
            iid=ice.addSupply(1, LocalDate.now(), 0, 10).getSupplyID();
            wid=water.addSupply(1, LocalDate.now(), 5, 5).getSupplyID();
