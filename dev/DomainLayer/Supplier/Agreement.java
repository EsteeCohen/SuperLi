...
public class Agreement {
    ...
    // A method to get discounts for a specific product
    ...
    // A method to calculate price with discount
    public double calculatePriceWithDiscount(Product product, int quantity) {
        ...
        if (discounts == null || discounts.isEmpty()) return product.getPrice() * quantity;
        double discount = 0.0;
